...
class MyMouseHandleSecondU extends JFrame implements MouseListener {  
    ...
    {  
    	long start = System.currentTimeMillis();
    	    ...
    	    mouseinfo = null;
    	        ...
    	        if ( mouseinfo=="left" && stimulus=="Save & Save as" |stimulus =="trans1"){
    	        	result = "Correct";
    	        }
    	        else
    	        {result = "Wrong";}
    	        ...
    	        if ( mouseinfo=="right" && stimulus=="Open & Close" |stimulus =="trans2"){
    	        	result = "Correct";
    	        }
    	        else
    	        {result = "Wrong";}
  ...
  //  		 System.out.println(i2+":"+mouseinfo + ":" + interval[x]);		
    	...
    	if (x!=0 & x>20){
    	 ...
    	 try {
               ...
               bw.newLine(); 
               if(x!=1 && x<=21){
             	  bw.write( name + "," + "2" + "," + (x-1) + "," + "Uncongruent" + "," + stimulus + "," + command + "," + gesture + "," + mouseinfo + "," + result + "," + time); 
                   bw.close(); 
               }
...
public class Experiment2U {  
    public static void main(String[] args) { 
    	
    	
	 
        new MyMouseHandleSecondU();  
