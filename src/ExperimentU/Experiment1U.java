...
class MyMouseHandleFirstU extends JFrame implements MouseListener {  
    ...
    {  
    	long start = System.currentTimeMillis();
    		   ...
    		   int c = e.getButton();
    	        ...
    	        if ( mouseinfo=="left" && stimulus=="Save as" |stimulus =="g1"){
    	        	result = "Correct";
    	        }
    	        else
    	        {result = "Wrong";}
    	        ...
    	        if ( mouseinfo=="right" && stimulus=="Save" |stimulus =="g2"){
    	        	result = "Correct";
    	        }
    	        else
    	        {result = "Wrong";}
    	...
    	if (x!=0 & x>20){
    	 ...
    	 x=x+1;
    	  ...
    	  try {
              ...
              bw.newLine(); 
              if(x!=1 && x<=21){
            	  bw.write( name + "," + "1" + "," + (x-1) + "," + "Uncongruent" + "," + stimulus + "," + command + "," + gesture + "," + mouseinfo + "," + result + "," + time); 
                  bw.close(); 
              }
...
public class Experiment1U {  
    public static void main(String[] args) { 
        new MyMouseHandleFirstU();  
        }
